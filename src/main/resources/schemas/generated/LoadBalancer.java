...
@XmlRootElement(name = "load-balancer")
public class LoadBalancer {

    @XmlAttribute(required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String name;
    @XmlAttribute(name = "lb-config-name", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String lbConfigName;
    @XmlAttribute(name = "auto-apply-enabled")
     ...
     *     
     */
    public void setLbConfigName(String value) {
     ...
     *     
     */
    public void setAutoApplyEnabled(String value) {
