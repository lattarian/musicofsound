...
@XmlRootElement(name = "external-jndi-resource")
public class ExternalJndiResource {

    @XmlAttribute(name = "jndi-name", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String jndiName;
    @XmlAttribute(name = "jndi-lookup-name", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
     ...
     *     
     */
    public void setJndiLookupName(String value) {
