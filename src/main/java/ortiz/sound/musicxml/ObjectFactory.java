 ...
 * generated in the ortiz.sound.musicxml package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ortiz.sound.musicxml
     * 
     */
    ...
    /**
     * Create an instance of {@link ortiz.sound.musicxml.String }
     * 
     */
    public ortiz.sound.musicxml.String createString() {
        return new ortiz.sound.musicxml.String();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ortiz.sound.musicxml.String }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "string", scope = Technical.class)
    public JAXBElement<ortiz.sound.musicxml.String> createTechnicalString(ortiz.sound.musicxml.String value) {
        return new JAXBElement<ortiz.sound.musicxml.String>(_TechnicalString_QNAME, ortiz.sound.musicxml.String.class, Technical.class, value);
    }
